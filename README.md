...
| Dockhand GUI | http://192.168.1.11:80 |
...
This repo was refactored out of `hlh-iac` monorepo (2026-09-21) to standalone `hlh-docker`. Deployments use pinned commits for
